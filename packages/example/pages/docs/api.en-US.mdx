...
| **visible** 🆕     | **Controlled mode: whether to show preview**                                 | **boolean**                                                                |                                          |
| **defaultIndex** 🆕| **Controlled mode: default index**                                           | **number**                                                                 | **0**                                    |
| **ref** 🆕         | **Ref for imperative control**                                               | **React.Ref&lt;PhotoProviderRef&gt;**                                      |                                          |
...
| ------ | --------------------- | --------------------------- |
| show   | Show photo at index   | (index?: number) =&gt; void |
| close  | Close preview         | () =&gt; void               |
